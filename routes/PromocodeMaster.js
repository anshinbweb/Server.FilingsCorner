...
router.post("/auth/list-by-params/PromocodeMaster", catchAsync(listPromocodeMasterByParams));

router.get("/auth/get/PromocodeMaster/:_id", catchAsync(getPromocodeMaster));

router.put("/auth/update/PromocodeMaster/:_id", catchAsync(updatePromocodeMaster));

router.delete("/auth/remove/PromocodeMaster/:_id", catchAsync(removePromocodeMaster));
